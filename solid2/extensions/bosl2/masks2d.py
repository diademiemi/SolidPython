...
class mask2d_roundover(_Bosl2Base):
    def __init__(self, r=None, inset=None, mask_angle=None, excess=None, flat_top=None, quarter_round=None, d=None, h=None, height=None, cut=None, joint=None, anchor=None, spin=None, **kwargs):
       super().__init__("mask2d_roundover", {"r" : r, "inset" : inset, "mask_angle" : mask_angle, "excess" : excess, "flat_top" : flat_top, "quarter_round" : quarter_round, "d" : d, "h" : h, "height" : height, "cut" : cut, "joint" : joint, "anchor" : anchor, "spin" : spin, **kwargs})
...
class mask2d_roundover(_Bosl2Base):
    def __init__(self, r=None, inset=None, mask_angle=None, excess=None, flat_top=None, d=None, h=None, height=None, cut=None, quarter_round=None, joint=None, anchor=None, spin=None, **kwargs):
       super().__init__("mask2d_roundover", {"r" : r, "inset" : inset, "mask_angle" : mask_angle, "excess" : excess, "flat_top" : flat_top, "d" : d, "h" : h, "height" : height, "cut" : cut, "quarter_round" : quarter_round, "joint" : joint, "anchor" : anchor, "spin" : spin, **kwargs})
